...
export function adjustHexBrightness(hex, offsetPercent) {
    const normalizedHex = normalizeHex(hex);
...
export function rgbaStringToRgba(str) {
...
export function toHwbString(H, W, B, alpha) {
    if (alpha !== undefined)
...
// ─── Utilities ───────────────────────────────────────────────────────────────
export function toHslString(h, s, l, alpha) {
    if (alpha !== undefined)
